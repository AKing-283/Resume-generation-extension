...
exports.PDFService = exports.ResumeStyle = void 0;
...
(function (ResumeStyle) {
    ...
    ResumeStyle["DEVELOPER"] = "developer";
})(ResumeStyle || (exports.ResumeStyle = ResumeStyle = {}));
/**
...
class PDFService {
     ...
     */
    async generatePDF(resumeData, options, endorsements) {
        let browser = null;
        try {
     ...
     */
    generateHTML(resumeData, style, endorsements) {
...
<body>
     ...
     * @returns string HTML content
     */
    getHTMLTemplate(resumeData, endorsements) {
        return `
            <div class="resume">
                <!-- Header Section -->
                <div class="header">
     ...
     * @returns string HTML content
     */
    generateSkillsHTML(skills, endorsements) {
        const categories = [
     ...
     */
    generatePreviewHTML(resumeData, style) {
        const css = this.getCSS(style);
